...
//     }
// });
// const noRepetirEnCarrito =(id)=>{

//     const productorepetido=carrito.some(Iphones=>Iphones.id==id)

//     console.log (productorepetido)

//     if (!productorepetido){

//         const modeloComprado=carrito.filter(Iphones=>{

//             if(id== Iphones.id){

//             }

//             return Iphones.nombre && Iphones.precio
//         })
//         carrito.push(modeloComprado)
...
//         console.log ('el cliente compro un iphone '+e.target.id)

//         noRepetirEnCarrito(e.target.id)
//     }
// });
...
//     if (BTNCarrito) {
//         const mostrarCarrito = confirm('¿Desea ver su carrito de compras?')
